<!--
 * @Author: your name
 * @Date: 2019-12-16 11:58:50
 * @LastEditTime : 2020-01-03 11:26:57
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /mimall/src/pages/detail.vue
 -->
<template>
  <div class="detail">
      ...
      <div class="container clearfix">
        <div class="swiper">
          <swiper :options="swiperOption">
              <swiper-slide><img src="/images/detail/phone-1.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="/images/detail/phone-2.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="/images/detail/phone-3.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="/images/detail/phone-4.jpg" alt=""></swiper-slide>
              <!-- Optional controls -->
      ...
      .content{
        ...
        .item-addr{
          ...
          .icon-loc{
            ...
            top: 27px;
            left: 34px;
            @include bgImg(20px,20px,'/images/detail/icon-loc.png');
          }
          .addr{
            color:#666666;
          }
