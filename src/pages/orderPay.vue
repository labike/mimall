<!--
 * @Author: your name
 * @Date: 2019-12-16 13:31:48
 * @LastEditTime : 2020-01-07 13:05:52
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /mimall/src/pages/orderPay.vue
 -->
<template>
  <div class="order-pay">
    <div class="wrapper">
      <div class="container">
        <div class="order-wrap">
          <div class="item-order">
            ...
            <div class="order-info">
              ...
              <p>收货信息：{{this.addressInfo}}</p>
            </div>
            <div class="order-total">
              <p>应付总额：<span>{{this.payment}}</span>元</p>
          ...
          <div class="item-detail" v-if="showDetail">
            <div class="item">
              ...
              <div class="detail-info theme-color">{{this.orderId}}</div>
            </div>
            <div class="item">
        ...
        <div class="item-pay">
          ...
          <div class="pay-way">
            ...
            <div class="pay pay-wechat" :class="{'checked': payType === 1}" @click="paySubmit(2)"></div>
          </div>
        </div>
      </div>
    </div>
